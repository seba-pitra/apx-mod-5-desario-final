...
(function() {
    ...
    (0, _tijeras.initTijeraComp)();
    (0, _piedra.initPiedraComp)();
...
},{"url:../../images/piedra.jpg":"6RlSI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6RlSI":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("7UhFu") + "piedra.1b4d58b9.jpg" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"d106K":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initPapelComp", ()=>initPapelComp);
const imagen = require("url:../../images/papel.jpg");
function initPapelComp() {
